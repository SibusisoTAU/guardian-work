...
export default function Page() {
      ...
      <div className="mx-auto flex min-h-[85vh] max-w-md items-center">
        <Card className="w-full overflow-hidden">
          ...
          <div className="p-6">
            ...
            <div className="mt-5 text-center text-xs text-slate-500">V5.9 introduces account ownership and authenticated access.</div>
          </div>
        </Card>
      </div>
    </div>
        ...
        <div className="grid gap-8 lg:grid-cols-[1.4fr_.6fr] lg:items-center">
          <div>
            <div className="mb-3 inline-flex rounded-full bg-orange-400 px-3 py-1 text-xs font-black text-slate-950">
              V5.9 - SECURE ACCOUNTS + TRUSTED DISCOVERY
            </div>
  ...
  const renderSettings = () => (
    <div className="space-y-6">
      ...
      <div className="text-xs text-slate-400">GUARDIAN WORK V5.9 - Secure Accounts - Smart Discovery - Saved Work - Business Shortlists</div>
    </div>
  );
