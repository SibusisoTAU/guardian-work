...
export default function Page() {
    ...
    <div className="space-y-6">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.4fr_.6fr] lg:items-center">
          <div>
            <div className="mb-3 inline-flex rounded-full bg-orange-400 px-3 py-1 text-xs font-black text-slate-950">
              V5.7.1 - LIVE INTELLIGENCE + SMART DISCOVERY
            </div>
      ...
      <Card className="p-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div><div className="text-xs font-black uppercase tracking-widest text-orange-500">V5.7.1 intelligence</div><h2 className="mt-1 text-xl font-black text-slate-900">Your Smart Matches</h2><p className="mt-1 text-xs text-slate-500">Ranked from your skills, experience, location, availability and Work Identity.</p></div>
  ...
  const renderAlerts = () => {
    ...
    return (
      <div className="space-y-6">
        <div>
          <div className="text-xs font-black uppercase tracking-widest text-orange-500">V5.7.1 - GUARDIAN ALERTS</div>
  ...
  const renderSettings = () => (
    <div className="space-y-6">
      ...
      <div className="text-xs text-slate-400">GUARDIAN WORK V5.7.1 - Live Intelligence - Smart Discovery - Personalisation</div>
    </div>
  );
    ...
    <div className={`guardian-work ${theme === "dark" ? "guardian-dark" : ""} min-h-screen bg-slate-50 text-slate-900`}>
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto flex max-w-7xl flex-col gap-2 px-4 py-8 text-xs text-slate-500 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div>V5.7.1 - Live Intelligence, Smart Discovery & Alerts</div>
        </div>
      </footer>
